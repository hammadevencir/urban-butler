  ...
  return (
    <section className="border-b border-[#E1D2BF] bg-[#FDF8F2]">
      <div className="mx-auto max-w-7xl px-6 py-16 sm:px-10 lg:py-20 xl:max-w-[1820px] xl:px-16">
        <div className="grid items-start gap-12 lg:grid-cols-2 xl:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)_minmax(280px,340px)] xl:gap-10">
          <Image
          ...
          <div className="max-w-xl lg:max-w-none">
            ...
            <p className="mt-4 text-base font-semibold text-[#1E1E1E] sm:text-lg">
