  ...
  return (
    <section className="bg-[#FDF8F2] border-b border-[#E1D2BF]">
      <div className="mx-auto max-w-7xl px-6 py-16 sm:px-10 lg:py-20 xl:max-w-[1820px] xl:px-16 xl:py-24">
        <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)] lg:gap-10 xl:gap-16">
          <div className="max-w-xl">
            <p className="text-xs font-medium uppercase text-primary sm:text-sm lg:text-base xl:text-lg">
              Why Urban Butler
            </p>

            <h2 className="mt-4 font-heading text-[2rem] leading-[1.15] text-[#1E1E1E] sm:text-4xl">
            ...
            <p className="mt-5 text-base leading-relaxed text-[#4A4A4A] sm:text-lg xl:text-xl">
              ...
              matters most. Decision, Precision, Trust. That is our standard.
            </p>
